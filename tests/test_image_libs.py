# from benchmark_utils import image_libs
...
def test_image_libs(img_lib):
    ...
    # assert len(image_libs_obj.available) == 1
    ...
    img_lib_obj.read('tests/test_imgs/cat.jpg')
    image_libs_obj[img_lib].read('tests/test_imgs/dog.jpg')
